...
# `sam3` — SAM3 text-prompted segmentation on the NPU, from Rust
...
[`iron-xrt`](../iron-xrt); everything else runs here in plain `std` Rust.
...
# 2. The runtime (links XRT; see ../iron-xrt)
cargo build --release
